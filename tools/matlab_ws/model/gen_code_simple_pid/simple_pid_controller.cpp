...
void Simple_PID_Controller::step(const real32_T *arg_diff,
                                 ...
                                 const real32_T *arg_d_gain,
                                 const boolean_T *arg_reset_req,
                                 const real32_T *arg_dt, real32_T *arg_out) {
  real32_T rtb_UdiffTsProdOut;
  // if (((*arg_reset_req) &&
  // (simple_pid_controller_DW.Integrator_PrevResetState <=
  //       0)) || ((!*arg_reset_req) &&
  ...
  *arg_out =
      (*arg_diff * *arg_p_gain + simple_pid_controller_DW.Integrator_DSTATE) +
      (rtb_UdiffTsProdOut - simple_pid_controller_DW.UD_DSTATE);
  simple_pid_controller_DW.Integrator_DSTATE +=
      *arg_diff * *arg_i_gain * *arg_dt *
      simple_pid_controller_P.Integrator_gainval;
  simple_pid_controller_DW.Integrator_PrevResetState =
      static_cast<int8_T>(*arg_reset_req);
...
Simple_PID_Controller::Simple_PID_Controller()
    : simple_pid_controller_DW(), simple_pid_controller_PrevZCX(),
      simple_pid_controller_M() {}

Simple_PID_Controller::~Simple_PID_Controller() {}

Simple_PID_Controller::RT_MODEL_simple_pid_controlle_T *
Simple_PID_Controller::getRTM() {
